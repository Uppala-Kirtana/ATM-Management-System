            ...
            <div class="row">
                ...
                <div class="col" style="text-align: center;justify-content: center; align-items: center; display: flex; padding-top: 30px; padding-bottom: 30px;">
                    <form action="" method="post">
                        ...
                        <h4 style="font-family: 'Times New Roman', Times, serif;">Account Type: <b><?php echo isset($accountTypeMessage) ? $accountTypeMessage : ''; ?></b></h4><br>

                        </label><br>
                        <table style="border:2px solid black; padding: 20px;">
                            <tr>
                            <th style="border:2px solid black; padding: 20px;">Name</th>

                                <th style="border:2px solid black; padding: 20px;">Account No.</th>

                                <th style="border:2px solid black; padding: 20px;">Balance</th>
                            </tr>
                            <tr>
                            <td style="border:2px solid black; padding: 20px;"><?php echo isset($a4) ? $a4 : ''; ?></td>
