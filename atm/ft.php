...
$qry2 = mysqli_query($conn, "SELECT ftransfer FROM u_acc WHERE status='1' AND ftransfer IS NOT NULL ORDER BY cdt DESC LIMIT 1") or die(mysqli_error($conn));
...
$qry3 = mysqli_query($conn, "SELECT cdt FROM u_acc WHERE status='1' AND u_id='$mainid' AND ftransfer IS NOT NULL ORDER BY cdt DESC LIMIT 1") or die(mysqli_error($conn));
                    ...
                    <form action="" method="post">
                        ...
                        <table style="border:2px solid black; padding: 20px;">
                            <tr>
                                ...
                                <th style="border:2px solid black; padding: 20px;">Amount Transfered</th>
                                <th style="border:2px solid black; padding: 20px;">Last Fund Transfered Timestamp</th>
                            </tr>
                            <tr>
